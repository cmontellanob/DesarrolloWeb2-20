...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-02-2021 a las 19:41:42
...
INSERT INTO `comentarios` (`id`, `idnoticia`, `comentario`, `idusuario`) VALUES
(NULL, 1, 'Ya exitian problemas antes', 2);
...
CREATE TABLE `tiponoticia` (
  `id` int(11) NOT NULL,
  `tiponoticia` varchar(30) NOT NULL
...
INSERT INTO `tiponoticia` (`id`, `tiponoticia`) VALUES
(1, 'Nacional'),
(2, 'Local'),
(3, 'Internacional');
